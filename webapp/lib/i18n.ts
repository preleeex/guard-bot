...
const dict = {
  ...
  // --- buttons / status / misc ---
  btn_save_scenario: { ru: "Сохранить сценарий", en: "Save scenario" },
  ...
  btn_manual_connect: { ru: "Подключить вручную", en: "Connect manually" },
  btn_add_bot_admin: { ru: "Добавить бота с правами админа", en: "Add the bot as admin" },
  st_scenario_saved: { ru: "Сценарий сохранён.", en: "Scenario saved." },
  st_settings_saved: { ru: "Настройки сохранены.", en: "Settings saved." },
  st_load_failed: { ru: "Не удалось загрузить.", en: "Could not load." },
  st_add_failed: { ru: "Не удалось добавить группу.", en: "Could not add the group." },
  st_pay_unavailable: { ru: "Оплата недоступна.", en: "Payment unavailable." },
  st_check_failed: { ru: "Не удалось проверить.", en: "Check failed." },
  session_missing: { ru: "Сессия не указана.", en: "Session not specified." },
  on_short: { ru: "вкл", en: "on" },
  off_short: { ru: "выкл", en: "off" },
  // --- owner: misc ---
  sub_panel_text: {
    ru: "Чтобы пользоваться панелью, подпишись на канал и нажми «Проверить».",
    en: "To use the panel, subscribe to the channel and tap Check.",
  },
  maint_title: { ru: "Технические работы", en: "Maintenance" },
  maint_text: { ru: "Загляни немного позже.", en: "Please check back a bit later." },
  profile_default: { ru: "Профиль", en: "Profile" },
  add_group_title: { ru: "Добавить группу", en: "Add group" },
  username_ph: { ru: "@username или id", en: "@username or id" },
  lang_ru: { ru: "Русский", en: "Russian" },
  lang_en: { ru: "English", en: "English" },
  // --- group settings ---
  res_title: { ru: "Результат проверки", en: "Verification result" },
  res_auto_approve: { ru: "Авто-одобрение при успехе", en: "Auto-approve on success" },
  res_auto_decline: { ru: "Авто-отклонение при провале", en: "Auto-decline on failure" },
  res_queue_threshold: { ru: "Очередь при пороге", en: "Queue at threshold" },
  res_threshold: { ru: "Порог, %", en: "Threshold, %" },
  timeout_title: { ru: "Время на прохождение", en: "Time to complete" },
  secs_ph: { ru: "секунды", en: "seconds" },
  secs_off_ph: { ru: "секунды, 0 = выкл", en: "seconds, 0 = off" },
  timeout_queue: { ru: "По таймауту: ручная проверка", en: "On timeout: manual review" },
  timeout_decline: { ru: "По таймауту: отклонить", en: "On timeout: decline" },
  cooldown_title: { ru: "Кулдаун после отказа", en: "Cooldown after decline" },
  allow_edit_title: { ru: "Разрешить менять ответ", en: "Allow changing answers" },
  voice_set_title: { ru: "Голосовая проверка", en: "Voice verification" },
  voice_prompt_ph: {
    ru: "Что записать (например: коротко расскажите о себе)",
    en: "What to record (e.g. tell us briefly about yourself)",
  },
  emoji_title: { ru: "Эмодзи-статус", en: "Emoji status" },
  paid_badge: { ru: "платно", en: "paid" },
  emoji_set: { ru: "задано", en: "set" },
  emoji_unset: { ru: "не задано", en: "not set" },
  emoji_use_current: { ru: "Использовать мой текущий эмодзи-статус", en: "Use my current emoji status" },
  emoji_reset: { ru: "Сбросить требование", en: "Reset requirement" },
  emoji_saved: { ru: "Эмодзи-статус сохранён.", en: "Emoji status saved." },
  emoji_cleared: { ru: "Эмодзи-статус сброшен.", en: "Emoji status reset." },
  emoji_failed: { ru: "Не удалось.", en: "Failed." },
  // --- group: journal ---
  journal_empty: { ru: "Журнал пуст.", en: "The journal is empty." },
  j_name: { ru: "Имя", en: "Name" },
  j_id: { ru: "ID", en: "ID" },
  j_when: { ru: "Когда", en: "When" },
  j_score: { ru: "Балл", en: "Score" },
  j_reason: { ru: "Причина", en: "Reason" },
  view_profile: { ru: "Посмотреть профиль", en: "View profile" },
  score_short: { ru: "балл", en: "score" },
  // --- preview ---
  prev_result: { ru: "Предпросмотр: результат", en: "Preview: result" },
  prev_title: { ru: "Предпросмотр", en: "Preview" },
  prev_empty: { ru: "Сценарий пуст. Добавьте блоки.", en: "The scenario is empty. Add blocks." },
  prev_leave: { ru: "Выйти из предпросмотра", en: "Leave preview" },
  prev_close: { ru: "Закрыть предпросмотр", en: "Close preview" },
  prev_queue: { ru: "На ручную проверку", en: "Manual review" },
  // --- info tips ---
  tip_guard: {
    ru: "Включает проверку при вступлении: человек проходит сценарий в Mini App, и только потом его впускают.",
    en: "Turns on join screening: the applicant passes the scenario in the Mini App and only then is admitted.",
  },
  tip_result: {
    ru: "Что делать с заявкой: авто-одобрить при успехе, авто-отклонить при провале, либо отправить в очередь на ручное решение при пороговом балле.",
    en: "What to do with a request: auto-approve on success, auto-decline on failure, or send to the queue for manual review at a threshold score.",
  },
  tip_time: {
    ru: "Сколько секунд даётся на прохождение. По истечении применяется действие ниже.",
    en: "How many seconds are given to complete. After that the action below applies.",
  },
  tip_cooldown: {
    ru: "Сколько секунд после отказа повторные заявки от этого человека авто-отклоняются, чтобы не спамил.",
    en: "For how many seconds after a decline repeat requests from this person are auto-declined to stop spam.",
  },
  tip_allow_edit: {
    ru: "Заявитель может вернуться назад и изменить ответ до отправки. Если выключено, ответы менять нельзя.",
    en: "The applicant can go back and change an answer before submitting. If off, answers cannot be changed.",
  },
  tip_voice: {
    ru: "Вместо Mini App заявителя просят записать голосовое боту в личку. Вы получаете его с кнопками Принять и Отклонить. Заменяет сценарий.",
    en: "Instead of the Mini App the applicant records a voice message to the bot. You receive it with Accept and Reject buttons. Replaces the scenario.",
  },
  tip_emoji: {
    ru: "Пускать только тех, у кого установлен нужный эмодзи-статус. Поставьте себе нужный статус и нажмите кнопку ниже, чтобы задать требование. Платная функция.",
    en: "Admit only users who have the required emoji status. Set the status on yourself and tap the button below to set the requirement. Paid feature.",
  },
  tip_welcome: {
    ru: "После одобрения бот публикует приветствие в группе с упоминанием нового участника. Можно автоудаление через N секунд.",
    en: "After approval the bot posts a welcome in the group mentioning the new member. Optional auto-delete after N seconds.",
  },
  // --- applicant: block form + ui ---
  bf_confirm: { ru: "Подтверждение", en: "Confirmation" },
  bf_not_robot: { ru: "Я не робот", en: "I am not a robot" },
  bf_answer: { ru: "Ответ", en: "Answer" },
  bf_enter_code: { ru: "Введите код", en: "Enter the code" },
  bf_questions: { ru: "Вопросы", en: "Questions" },
  bf_agree: { ru: "Согласен", en: "I agree" },
  bf_unknown: { ru: "Неизвестный тип блока:", en: "Unknown block type:" },
  ui_whatis: { ru: "Что это", en: "What is this" },
  ui_got_it: { ru: "Понятно", en: "Got it" },
  ui_loading: { ru: "Загрузка", en: "Loading" },
  ui_error: { ru: "Ошибка", en: "Error" },
  ui_retry: { ru: "Повторить", en: "Retry" },
  // --- owner: language ---
